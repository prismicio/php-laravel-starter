...
<body>
    <header>
        <nav><a href="#bootstrap"><strong>Configure a repository</strong></a><a href="https://prismic.io/docs/php/getting-started/with-the-php-starter-kit" target="_blank" class="doc">Documentation<img src="{{ asset('img/open.svg') }}" alt="Open"></a>
        </nav>
        <div class="wrapper">
